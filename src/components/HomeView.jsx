import { btnPrimary } from '../App'; // Importamos estilos si es necesario, o definimos locales

export default function HomeView({ login, setView, user }) {
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
      <div style={{ marginBottom: 30, padding: 20 }}>
        <img src="https://upload.wikimedia.org/wikipedia/commons/8/8b/Escudo_de_los_Reyes_Catolicos_%281475-1492%29.svg" 
             alt="Escudo" style={{ width: "min(220px, 50vw)", height: "auto", objectFit: "contain", filter: "drop-shadow(0 4px 12px rgba(0,0,0,0.3))" }} />
      </div>
